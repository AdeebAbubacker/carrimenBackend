...
import { adminRoleRouter, getbankRouter, createBankRouter,createFormWizard,createQR } from './routes/routes.js';
...
app.use('/api/get_form', createFormWizard);
